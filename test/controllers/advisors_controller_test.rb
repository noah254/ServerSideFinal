...
class AdvisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advisor" do
    assert_difference('Advisor.count') do
      post advisors_url, params: { advisor: { advisorid: @advisor.advisorid, email: @advisor.email, firstname: @advisor.firstname, lastname: @advisor.lastname, student_id: @advisor.student_id } }
    end
  ...
  test "should update advisor" do
    patch advisor_url(@advisor), params: { advisor: { advisorid: @advisor.advisorid, email: @advisor.email, firstname: @advisor.firstname, lastname: @advisor.lastname, student_id: @advisor.student_id } }
